...
%% ========== Графики ==========
% Общие настройки шрифта (можно изменить)
font_name = 'GOST type A';
font_size = 22;

% 1. Скорость
figure('Name', 'Скорость автомобиля', 'NumberTitle', 'off');
plot(t, v*3.6, 'b-', 'LineWidth', 3);
xlabel('Время, с', 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size);
ylabel('Скорость, км/ч', 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size);
title('Профиль скорости', 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size, 'FontWeight', 'normal');
grid on; set(gca, 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size);
...
grid on; set(gca, 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size);
ylim([cvt.ratio_min cvt.ratio_max]);

% 3. Момент ДВС
figure('Name', 'Момент ДВС', 'NumberTitle', 'off');
plot(t, torque_points, 'r-', 'LineWidth', 3);
xlabel('Время, с', 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size);
ylabel('Крутящий момент ДВС, Н·м', 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size);
title('Момент двигателя внутреннего сгорания', 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size, 'FontWeight', 'normal');
grid on; set(gca, 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size);

% 4. Момент МГ
figure('Name', 'Момент электромотора', 'NumberTitle', 'off');
plot(t, mg_torque_points, 'm-', 'LineWidth', 3);
xlabel('Время, с', 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size);
ylabel('Момент МГ, Н·м', 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size);
title('Момент мотора-генератора', 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size, 'FontWeight', 'normal');
grid on; set(gca, 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size);

% % 5. SOC
% figure('Name', 'Состояние заряда батареи', 'NumberTitle', 'off');
% plot(t, SOC_history*100, 'k-', 'LineWidth', 3);
% xlabel('Время, с', 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size);
% ylabel('SOC, %', 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size);
% title('Уровень заряда батареи', 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size, 'FontWeight', 'normal');
% grid on; set(gca, 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size);
% ylim([0 100]);

% 6. Положение педали газа
figure('Name', 'Педаль газа', 'NumberTitle', 'off');
plot(t, pedals*100, 'k-', 'LineWidth', 3);
xlabel('Время, с', 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size);
ylabel('Педаль газа, %', 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size);
title('Положение педали акселератора', 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size, 'FontWeight', 'normal');
grid on; set(gca, 'FontName', font_name, 'FontAngle', 'Italic', 'FontSize', font_size);
ylim([0 100]);
